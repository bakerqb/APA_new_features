...
class ApaWebScraper:
    ...
    def scrapeDivision(self, divisionId):
        ...
        playerMatches = list(map(lambda playerMatch: self.converter.toPlayerMatchWithSql(playerMatch), self.db.getPlayerMatches(None, divisionId, None, None, None, None, None, None)))
